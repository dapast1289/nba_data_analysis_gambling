...
# 隨機取樣法
def randon_result_analysis(game_result_list, lose_key, continue_lose_num, randon_sample_count, thread_id, sub_thread_id,
						   consider_ignore_game=False):
...
def test_randon_case_by_multi_thread(thread_id, game_result_list, lose_keyword, continue_lose_num, sample_count):
	...
	with ThreadPoolExecutor(max_workers=max_threads) as executor:
		...
		for index, sample in enumerate(sample_per_work):
			...
			future = executor.submit(randon_result_analysis, game_result_list, lose_keyword, continue_lose_num, sample, thread_id, sub_thread_id)
